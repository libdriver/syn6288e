...
SYN6288E 中文語音合成芯片是北京宇音天下科技有限公司於 2010 年初推出的一款性價比更高，效果更自然的一款中高端語音合成芯片。 SYN6288E 通過異步串口接收待合成的文本，實現文本到聲音（ TTS ）的轉換。最新推出的 SYN6288E 語音合成芯片繼承OSYNO6188 的優秀特點：最小 LQFP32L貼片封裝，硬件接口簡單，極高的性價比；除此之外， SYN6288E 文本識別更智能，語音合成更自然，語音合成效果和智能識別效果大幅度提高，是一款面向中高端應用領域的語音合成芯片。

LibDriver SYN6288E 是LibDriver推出的SYN6288E 的全功能驅動，該驅動提供文本合成、音樂合成、報警聲音合成等功能並且它符合MISRA標準。
...
/src目錄包含了LibDriver SYN6288E的源文件。

/interface目錄包含了LibDriver SYN6288E與平台無關的UART模板。

/test目錄包含了LibDriver SYN6288E驅動測試程序，該程序可以簡單的測試芯片必要功能。

/example目錄包含了LibDriver SYN6288E編程範例。

/doc目錄包含了LibDriver SYN6288E離線文檔。

/datasheet目錄包含了SYN6288E數據手冊。
...
在線文檔: [https://www.libdriver.com/docs/syn6288e/index.html](https://www.libdriver.com/docs/syn6288e/index.html)。
