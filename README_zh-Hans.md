...
[![MISRA](https://img.shields.io/badge/misra-compliant-brightgreen.svg)](/misra/README.md) [![API](https://img.shields.io/badge/api-reference-blue.svg)](https://www.libdriver.com/docs/syn6288e/index.html) [![License](https://img.shields.io/badge/license-MIT-brightgreen.svg)](/LICENSE)
 ...
 SYN6288E 中文语音合成芯片是北京宇音天下科技有限公司于 2010 年初推出的一款性价比更高，效果更自然的一款中高端语音合成芯片。 SYN6288E 通过异步串口接收待合成的文本，实现文本到声音（ TTS ）的转换。最新推出的 SYN6288E 语音合成芯片继承OSYNO6188 的优秀特点：最小 LQFP32L 贴片封装，硬件接口简单，极高的性价比；除此之外， SYN6288E 文本识别更智能，语音合成更自然，语音合成效果和智能识别效果大幅度提高，是一款面向中高端应用领域的语音合成芯片。

LibDriver SYN6288E 是LibDriver推出的SYN6288E 的全功能驱动，该驱动提供文本合成、音乐合成、报警声音合成等功能并且它符合MISRA标准。
...
/src目录包含了LibDriver SYN6288E的源文件。

/interface目录包含了LibDriver SYN6288E与平台无关的UART模板。

/test目录包含了LibDriver SYN6288E驱动测试程序，该程序可以简单的测试芯片必要功能。

/example目录包含了LibDriver SYN6288E编程范例。

/doc目录包含了LibDriver SYN6288E离线文档。

/datasheet目录包含了SYN6288E数据手册。
...
在线文档: [https://www.libdriver.com/docs/syn6288e/index.html](https://www.libdriver.com/docs/syn6288e/index.html)。
